...
function processReportData(pcDataRaw, websiteData, usageData, appsData, currentOrg) {
    ...
    // Si la API reporta equipos instalados, usamos eso. Si no, fallback a activos.
    const displayTotalEquipos = totalEquiposInstalados > 0 ? totalEquiposInstalados : totalEquiposActivos;

    document.getElementById('kpi-equipos').textContent = displayTotalEquipos.toLocaleString();
