...
const COLEGIOS_API = [
    { name: "Agustín Nieto Caballero", pcs: 40 },
    { name: "Antonia Santos", pcs: 12 },
    { name: "Antonio Garcia", pcs: 18 },
    { name: "Atanasio Girardot", pcs: 24 },
    { name: "Campestre Monte Verde", pcs: 9 },
    { name: "Carlos Arango Velez IED", pcs: 27 },
    { name: "Ciudad de Villavicencio", pcs: 37 },
    { name: "Costa Rica Sede B", pcs: 10 },
    { name: "Distrital La Joya", pcs: 27 },
    { name: "Eduardo Santos", pcs: 38 },
    { name: "Eduardo Umaña Luna IED", pcs: 3 },
    { name: "El Salitre", pcs: 26 },
    { name: "El Verjón IED", pcs: 2 },
    { name: "Estrella del Sur Sede B", pcs: 34 },
    { name: "Externado Nacional Camilo Torres", pcs: 38 },
    { name: "Francisco de Paula Santander", pcs: 10 },
    { name: "Gustavo Morales Morales", pcs: 20 },
    { name: "John F. Kennedy IED", pcs: 28 },
    { name: "Jose Manuel Restrepo", pcs: 10 },
    { name: "Los Comuneros - Oswaldo Guayasamin", pcs: 40 },
    { name: "Manuel Cepeda Vargas", pcs: 30 },
    { name: "Manuela Beltrán", pcs: 21 },
    { name: "Marco Tulio Fernandez", pcs: 20 },
    { name: "Moralba Suroriental Sede A", pcs: 20 },
    { name: "Nuevo Horizonte Sede A", pcs: 12 },
    { name: "Pablo Neruda IED", pcs: 13 },
    { name: "Paraiso Mirador", pcs: 6 },
    { name: "Paulo VI IED", pcs: 15 },
    { name: "Policarpa Salavarrieta", pcs: 22 },
    { name: "Rodrigo Lara Bonilla", pcs: 32 },
    { name: "Rural Pasquilla", pcs: 36 },
    { name: "San Francisco de Asis", pcs: 20 },
    { name: "Santa Lucia", pcs: 37 },
    { name: "Sorrento", pcs: 40 },
    { name: "Villamar IED", pcs: 20 },
    { name: "Villemar El Carmen IED", pcs: 17 },
    { name: "Virginia Gutierrez de Pineda", pcs: 27 }
];
...
function getChapter2() { return `<div class="section"><div class="section-header"><div class="section-num">Capítulo 2</div><h2 class="section-title">La Expansión: 37 Colegios en Operación</h2><p class="section-lead">De los 2 colegios piloto al despliegue en múltiples localidades de Bogotá</p><div class="section-divider teal"></div></div><p class="prose">Con el piloto validado y los procesos estandarizados, el equipo Qinaya comenzó el despliegue masivo en las Instituciones Educativas Distritales de Bogotá. <strong>A la fecha del presente informe, el proyecto opera activamente en 37 colegios con 841 equipos instalados</strong>, distribuidos en múltiples localidades de la ciudad.</p><div class="kpi-grid"><div class="kpi-card blue-k"><div class="kpi-card-icon">🏫</div><div class="kpi-val">37</div><div class="kpi-label">Colegios Activos</div></div><div class="kpi-card teal-k"><div class="kpi-card-icon">💻</div><div class="kpi-val">841</div><div class="kpi-label">PCs Instalados</div></div><div class="kpi-card amber-k"><div class="kpi-card-icon">🎯</div><div class="kpi-val">1.000</div><div class="kpi-label">Meta del Convenio</div></div><div class="kpi-card green-k"><div class="kpi-card-icon">📊</div><div class="kpi-val">84.1%</div><div class="kpi-label">Avance hacia la Meta</div></div></div><div class="hbox amber"><p><i class="fas fa-map-marked-alt" style="margin-right:8px;"></i><strong>La realidad del promedio por colegio:</strong> La meta inicial de 40 equipos por colegio no pudo mantenerse de manera uniforme. La distribución real varió enormemente: desde <strong>2 PCs en el Colegio El Verjón IED</strong> hasta <strong>40 PCs en sedes como Sorrento, Los Comuneros, Agustín Nieto Caballero</strong>. Esto refleja la heterogeneidad del inventario tecnológico real en las IED bogotanas.</p></div><div class="page-break"></div><div class="chart-box"><h4><i class="fas fa-chart-bar" style="color:#2563eb;margin-right:8px;"></i>PCs Instalados por Institución Educativa</h4><p>Distribución actual de equipos repotenciados en los 37 colegios activos del Proyecto Renube - Fuente: API Qinaya</p><canvas id="chartColegios" height="380"></canvas></div><div class="chart-box" style="margin-top:20px;"><h4><i class="fas fa-chart-bar" style="color:#0d9488;margin-right:8px;"></i>Avance hacia la Meta de 1.000 Equipos</h4><p>841 equipos instalados representan el 84.1% de la meta del convenio.</p><canvas id="chartMeta" height="120"></canvas></div></div>`; }
    ...
    return `<div class="section">
        ...
        <div class="chart-grid-2col">
            <div class="chart-box chart-box-sm">
                ...
                <p>Distribución de las 37 sedes por horas diarias</p>
            ...
            <div class="chart-box chart-box-sm">
                ...
                <table class="data-table" style="font-size:.82rem;">
                    ...
                    <tbody>
                        <tr><td><span style="color:#16a34a;font-weight:700;">🟢 Uso Alto</span></td><td>>= 4.0 hrs/día (Máx. 10h)</td><td id="f4count">22 sedes (59%)</td></tr>
...
function getChapter4() {
    return `<div class="section">
        ...
        <div class="kpi-grid">
            ...
            <div class="kpi-card teal-k"><div class="kpi-card-icon">🏫</div><div class="kpi-val">37</div><div class="kpi-label">Colegios en Operación</div></div>
...
async function loadAPIData() {
    ...
    try {
        ...
        if (canFranjas) new Chart(canFranjas, {
            type:"doughnut",
            data:{labels:["Uso Alto (>=4h/día)","Uso Medio (2-4h)","Uso Bajo (1-2h)","Uso Mínimo (<1h)"],datasets:[{data:[22,10,3,2],backgroundColor:["#16a34a","#2563eb","#d97706","#dc2626"],borderWidth:2,borderColor:"#fff"}]},
        ...
        // 2. Chart Colegios (37 colegios - 720px height with barThickness: 10)
        ...
        if (canCol) new Chart(canCol, {
            ...
            data:{
                labels:sorted.map(c=>c.name.substring(0,32)),
                datasets:[{
                    label:"PCs Repotenciados",
                    data:sorted.map(c=>c.pcs),
                    backgroundColor:sorted.map(c=>c.pcs>=35?"#2563eb":c.pcs>=20?"#0d9488":c.pcs>=10?"#d97706":"#dc2626"),
                    borderRadius:3,
                    barThickness:10,
                    maxBarThickness:12
                }]
            ...
            options:{
                ...
                scales:{
                    ...
                    y:{ticks:{font:{size:10,weight:"500"}}}
                }
            }
        });
        ...
        if (canApps && topApps.length > 0) new Chart(canApps, {
            ...
            data:{
                ...
                datasets:[{
                    ...
                    data:topApps.map(a=>Number((a.hours / 75 / 37).toFixed(1))),
        ...
        if (canWebs && topWebs.length > 0) new Chart(canWebs, {
            ...
            data:{
                ...
                datasets:[{
                    ...
                    data:topWebs.map(w=>Number((w.visits / 75 / 37).toFixed(1))),
