    ...
    return `<div class="page-break"></div><div class="section">
        ...
        <div class="chart-grid-2col">
            <div class="chart-box chart-box-sm">
                ...
                <div style="text-align:center;margin-top:10px;">
                    <img src="foto_meet_capacitacion.png" alt="Capacitaciones virtuales del Sistema Operativo y solución Qinaya" style="max-width:100%;max-height:165px;border-radius:6px;border:1px solid #e2e8f0;object-fit:cover;">
                </div>
            </div>
            <div class="chart-box chart-box-sm">
                ...
                <div style="text-align:center;margin-top:10px;">
                    <img src="foto_chat_whatsapp.png" alt="Acompañamiento Activo en Grupos de WhatsApp" style="max-width:100%;max-height:165px;border-radius:6px;border:1px solid #e2e8f0;object-fit:cover;">
                </div>
            </div>
        </div>
        ...
        <div class="chart-grid-2col">
            ...
            <div class="chart-box chart-box-sm" style="text-align:center;">
                ...
                <img src="foto_pantalla_scratch.png" alt="Evidencia de Acompañamiento en el Aula" style="max-width:100%;max-height:170px;border-radius:6px;border:1px solid #e2e8f0;object-fit:cover;margin-top:6px;">
            </div>
        </div>
